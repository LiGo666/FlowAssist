...
export async function handleFeedback(req, res) {
    ...
    try {
        ...
        const result = await pool.query(`INSERT INTO telemetry.feedback (trace_id, user_id, rating, comment)
       VALUES ($1, $2, $3, $4)
       RETURNING feedback_id`, [traceId, userId || 'anonymous', rating, comment || null]);
